/* ───────────────────── IntroTunnel ─────────────────────
   ...
   Sequence:
     ...
     2. 'reveal'  — tunnel ends on a clean screen; the
                    Proud Nature Buildtech Pvt Ltd lockup fades in
                    and holds.
     3. 'out'     — the whole thing dissolves (fade + scale +
                    blur) into the landing page.
     4. 'gone'    — unmounts and calls onDone().

   Customised for Proud Nature Buildtech Pvt Ltd (blue room, brand phrase).
*/
...
const PHRASE = 'Proud Nature Buildtech Pvt Ltd · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>Proud Nature Buildtech Pvt Ltd</span><span>REALTY</span></div>
